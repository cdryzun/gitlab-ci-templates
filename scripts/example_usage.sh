...
# 示例 1: 转换 PRE 环境 URL
test_url_pre="https://next.cpinnov.run/PRE/some-service"
...
# 示例 2: 转换 TEST 环境 URL
test_url_test="https://next.cpinnov.run/TEST/another-service"
...
# 示例 3: 转换 PROD 环境 URL
test_url_prod="https://next.cpinnov.run/PROD/production-service"
